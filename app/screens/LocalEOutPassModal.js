...
export default function LocalEOutPassModal( values ) {
    ...
    return (
        <ScrollView style={styles.scrollView}>
            <View style={styles.container}>
                ...
                <View style={styles.passContainer}>
                    <View style={styles.outpassImageContainer}>
                        <Image source={{ uri: finalData.images }} style={styles.stdimage} />
                    </View>
                    <Text style={styles.localText}>Local e-outpass</Text>
                    <View style={styles.detailsContainer}>
                        ...
                        <OutpassText placeholder="Day of outing" value={finalData.date} width="32%" />
                        <OutpassText placeholder="Out time" value={finalData.outTime} width="22%" />
                        <OutpassText placeholder="In time" value={finalData.inTime} width="19%" />
            ...
            {/*<View style={styles.buttonContainer}>
                <AppButton name="print" onPress={() => window.print} />
            </View>*/}
        </ScrollView>
    )
}
